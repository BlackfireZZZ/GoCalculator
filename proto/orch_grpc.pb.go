...
const (
	OrchestratorService_Ping_FullMethodName          = "/orchestrator.OrchestratorService/Ping"
	OrchestratorService_RegisterAgent_FullMethodName = "/orchestrator.OrchestratorService/RegisterAgent"
)
...
func (c *orchestratorServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrchestratorService_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orchestratorServiceClient) RegisterAgent(ctx context.Context, in *RegisterAgentRequest, opts ...grpc.CallOption) (*RegisterAgentResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrchestratorService_RegisterAgent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
